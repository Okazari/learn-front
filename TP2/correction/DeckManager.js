...
class DeckManager {
  constructor(fixtures) {
    ...
    for (const fixture of fixtures) {
      cards.push(new Card(fixture.name, fixture.health, fixture.strength, fixture.category));
    }
    this.cards = cards;
  }
  ...
  getRandomCard() {
    const card = this.cards[this.getRandomIntInclusive(0, this.cards.length - 1)];
    return {
      name: card.name,
      health: card.health,
